...
from .config import DATASET_DOWNLOAD, DATA_EXTRACTED_DIR

def extract_dataset(dataset_name):
    """手动解压 OpenWebText 数据集"""
    
    DATA_DIR = os.path.join(DATASET_DOWNLOAD, dataset_name, "subsets")
    output_dir = os.path.join(DATA_EXTRACTED_DIR, dataset_name)
